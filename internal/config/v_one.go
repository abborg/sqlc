...
import (
	...
	golang "github.com/abborg/sqlc/internal/codegen/golang/opts"
)
...
type v1PackageSettings struct {
	...
	EmitSemanticDuplicateColumnNames bool              `json:"emit_semantic_duplicate_column_names,omitempty" yaml:"emit_semantic_duplicate_column_names"`
		...
		conf.SQL = append(conf.SQL, SQL{
			...
			Gen: SQLGen{
				Go: &golang.Options{
					...
					EmitSemanticDuplicateColumnNames: pkg.EmitSemanticDuplicateColumnNames,
